...
class _Full(torch.nn.Module):
    ...
    The network flattens a 28x28 input image, passes it through a single
    ...
    def forward(self, x):
        ...
        return torch.nn.functional.log_softmax(self._f2(x), dim=1)
...
class _Conv(torch.nn.Module):
    ...
    layers. It expects single-channel 28x28 images and produces
    log-probabilities over 10 classes.
    """
